...
int main(){
    ...
    TPilha **vetPilhas;
    int crioubase = 0, crioulistadenomes = 0, criouparticoes = 0;
    //int crioupilhas = 0;
        ...
        switch (op){
            ...
            case (6):
                if(crioulistadenomes){
                    ...
                    //salvando o ponteiro para o início da lista de nomes
                    prox = nomes;
                    organiza_p(nomes, nParticoes, nFunc);
                    exibe(nomes, nParticoes, nFunc);
                    criouparticoes=1;
                    printf("\n\nPartições criadas no metodo de seleção natural com sucesso!!");
           ...
           case (7):
            ...
            case (9):
                ...
                if(criouparticoes){
                    //if(crioupilhas){
                        intercalacao_arvore_de_vencedores(nParticoes, nomes);
	...
	free(vetPilhas); SE USAR A PILHA, DESMARQUE*/
